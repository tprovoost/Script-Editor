 ...
 * happening in CDE/Motif and Metal Look and Feels.
 * GTK+ and nimbus works perfect. No Idea why? if anybody could point out the mistake that'd be
...
public class JSplitButton extends JButton implements MouseMotionListener, MouseListener, ActionListener, Serializable
{
     ...
     * line drawn when you hover your mouse
     * over the split part of the button).
     * 
